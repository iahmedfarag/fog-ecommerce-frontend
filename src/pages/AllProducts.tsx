            ...
            <div className="container">
                ...
                <div className="content">
                    <div className="filters">
                        <FilterRow text={`price`} price={filtersObject.price} filterBy="price" />
                        <FilterRow text={`models`} items={filtersObject.models} filterBy="model" />
                        <FilterRow text={`brands`} items={filtersObject.brands} filterBy="brand" />
                        <FilterRow text={`colors`} items={filtersObject.colors} filterBy="color" />
                    </div >
                ...
                <div className="pagination">
                    {
                        Array.from(Array(pages), (_, i) => {
                            return <button className={`${filters.currentPage === i + 1 ? 'active' : ''}`} key={i} onClick={() => dispatch(filterProducts({ currentPage: i + 1 }))}>{i + 1}</button>
                        })
                    }
                </div>
            </div>
